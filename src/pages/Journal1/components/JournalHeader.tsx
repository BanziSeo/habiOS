...
export const JournalHeader: React.FC<JournalHeaderProps> = ({
  ...
  const [tempTitle, setTempTitle] = useState(journalNames.journal1);

  useEffect(() => {
    setTempTitle(journalNames.journal1);
  }, [journalNames.journal1]);
  ...
  const handleTitleSave = () => {
    updateJournalName('journal1', tempTitle);
