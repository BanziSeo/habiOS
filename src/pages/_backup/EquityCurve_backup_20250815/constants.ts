...
export const DEFAULT_MOVING_AVERAGES: MovingAverage[] = [
  { id: 'ma1', enabled: true, type: 'EMA', period: 10, color: '#ff0000', width: 1 },
  { id: 'ma2', enabled: true, type: 'EMA', period: 21, color: '#0000ff', width: 1 },
  { id: 'ma3', enabled: true, type: 'SMA', period: 50, color: '#ff8c00', width: 1 },
  { id: 'ma4', enabled: true, type: 'SMA', period: 100, color: '#808080', width: 1 },
  { id: 'ma5', enabled: true, type: 'SMA', period: 200, color: '#00ff00', width: 1 }
];
