          ...
          <>
            {fields.map((field, index) => (
              <Row key={field.key} gutter={8} align="middle" style={{ marginBottom: 8 }}>
                ...
                <Col span={7}>
                  <Form.Item name={[field.name, 'lineStyle']} style={{ marginBottom: 0 }}>
                    <Select size="small" placeholder="Style" style={{ width: '100%' }}>
                      <Select.Option value="solid">Line</Select.Option>
                      <Select.Option value="dashed">Dotted</Select.Option>
                    </Select>
                  </Form.Item>
                </Col>
              </Row>
